 ...
 */
/*64070507201 -Modified 2023-09-25 - Make it more suitable for each size and optionnal. */
typedef struct {
...
/*64070507201 -Modified 2023-09-25 - change extrack method */

void setData(USER_T *pUser, char*username, char *firstname, char * lastname, char *birthday)
{
...
/*64070507201 -Modified 2023-09-25 - Extrack method */
 ...
 */
void checkArgumentFile(int numberArgument, char *filename)
{
  int status = 1;
  if (numberArgument < 2)
  {
 ...
 * doing different operations
 */
/*64070507201 -Modified 2023-09-25 - improve code quality, readability, and maintainability while reducing code smells in the original implementation */
int main(int argc, char *argv[])
{
  int option = 0;
  checkArgumentFile(argc, argv[1]);
  while (option != EXIT_THE_PROGRAM)
  {
    ...
    case CREATE_NEW_USER:
      createNewUser();
      break;
    case SHOW_USER_FRIENDS:
      showUserFriends();
      break;
    case SUGGEST_NEW_FRIENDS:
      suggestNewFriends();
      break;
