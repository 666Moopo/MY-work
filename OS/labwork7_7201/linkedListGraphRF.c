...
/*64070507201 -modify 2023-09-25 -freeAdjacent void order: define a function before using it.*/

static VERTEX_T * vListHead = NULL;  /* head of the vertex list */
static VERTEX_T * vListTail = NULL;  /* tail of the vertex list */
static int bGraphDirected = 0;       /* if true, this is a directed graph */
void freeAdjacenList(VERTEX_T * pVertex)
{
